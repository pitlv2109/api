...
type ServiceRoleBinding struct {
	...
	// $hide_from_docs
	// Support inline role definition, essentially replace “roleRef” section in binding
	// with the role definition itself.
	...
	// ServiceRoleBinding binds to. The value of `role` is the name of the ServiceRole,
	// and it can start with or without a forward slash ("/").
